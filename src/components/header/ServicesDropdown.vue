...
<template>
  <div
    class="fixed left-0 w-full bg-white border-t border-gray-200 shadow-xl z-50 flex items-center justify-center rounded-b-2xl overflow-hidden"
    :style="{ top: '80px', height: '400px' }"
  >
    <div class="flex w-full h-full">
      <!-- First part: 1/8 width, blank -->
      <div class="w-2/9 h-full border-r border-gray-200"></div>
      <!-- Second part: 3/8 width, title and list -->
      <div class="w-3/9 h-full flex ml-4 flex-col pt-2 border-r border-gray-200">
        <div class="text-left">
          <div class="text-xl font-bold mb-4 text-gray-800">Services</div>
          <ul class="space-y-2">
            <li>
               <a href="#" class="text-gray-700 hover:text-red-600 transition-colors flex items-center group">
      ...
      <div class="w-4/9 h-full flex flex-col px-8">
        <div class="flex space-x-4 border-b border-gray-200 mb-4">
          <button
            ...
            :key="tab"
            @click="activeTab = idx"
            :class="['font-mgm py-2 px-4 font-semibold focus:outline-none', activeTab === idx ? 'border-b-2 border-red-600 text-red-600' : 'text-gray-700']"
          >
            {{ tab }}
          </button>
        </div>
